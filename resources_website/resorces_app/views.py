...
def def_home(request):
    ...
    return render(request, './resorces_app/home.html',{'branch':all_branch})
...
def def_pyq(request,branch_name):
    ...
    return render(request, 'resorces_app/pyq_show.html',{'data':pyq_data,'branch':branch})
...
def show_year(request,student_year,branch_name):
    ...
    return render(request, 'resorces_app/year_wise.html',{'data':pyq_year})
...
def year_year(request,student_year,branch_name,year):
    ...
    return render(request, 'resorces_app/year_wise.html',{'show':pyq_year,'data':pyq_year1,'pdf':pyq_pdf1[0].pyq_pdf})



def def_about(request):
    return render(request, 'resorces_app/about.html')
def def_team(request):
    return render(request, 'resorces_app/team.html')
def def_contact(request):
    return render(request, 'resorces_app/contact.html')
